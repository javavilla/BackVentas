package co.edu.unbosque.lagenericiclo4.BackVentas;
...
public class SwaggerConfig {
	...
	public Docket apiDocket() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("co.edu.unbosque.lagenericiclo4.BackVentas")).paths(PathSelectors.any())
